                ...
                <div class="card mt-5 shadow-lg p-5 responsive-container">
                    <div class="row">
                                ...
                                <form method="POST" action="{{ route('register.store') }}">
                                    ...
                                    <div class="mb-3 d-flex">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="role" id="pts"
                                                value="pts" />PTS
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="role" id="umum"
                                                value="umum" />Umum
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap"
                                            aria-describedby="emailHelp" placeholder="Nama Anda" />
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="nomor_telepon"
                                            name="nomor_telepon" inputmode="numeric" autocomplete="off"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email"
                                            aria-describedby="emailHelp" autocomplete="off" placeholder="Email Anda" />
                                    </div>
                                    <div class="mb-3 pts-only">
                                        <label for="nama_pts" class="form-label">Nama PTS (PTS ONLY)</label>
                                        <input type="text" class="form-control" id="nama_pts" name="nama_pts"
                                            autocomplete="off" placeholder="Nama PTS" />
                                    </div>
                                    <div class="mb-3 pts-only">
                                        <label for="jabatan" class="form-label">Jabatan (PTS ONLY)</label>
                        ...
                        <div
                            ...
                            <img src="{{ asset('images/Hacker-amico.svg') }}" class="img-fluid" alt="team spirit" />
                            <div class="w-100 d-flex flex-column align-items-start mt-3">
                                ...
                                <div class="social-media">
                                    <a href="https://tiktok.com/@humas.lldikti1" class="btn btn-dark"
                                        target="_blank">
                                        <i class="bi bi-tiktok"></i>
                                    </a>
                                    <a href="https://www.instagram.com/humas.lldikti1/" class="btn btn-info"
                                        target="_blank">
                                        <i class="bi bi-instagram"></i>
                                    </a>
                                    <a href="https://x.com/humaslldikti1/" class="btn btn-dark" target="_blank">
                                        <i class="bi bi-twitter-x"></i>
                                    </a>
                                    <a href="https://www.youtube.com/@humas.lldikti1344" class="btn btn-danger"
                                        target="_blank">
