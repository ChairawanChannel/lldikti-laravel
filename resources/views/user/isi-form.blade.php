            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/user/dashboard.html">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/user/buat-permohonan.html">Buat Permohonan</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="card shadow-lg p-5">
                ...
                <form>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="/user/buat-permohonan.html" class="btn btn-secondary">Kembali</a>
                        <a href="/user/konfirmasi.html" type="submit" class="btn btn-primary">Selanjutnya</a>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <iframe
                            ...
                            width="330" height="180" style="border: 0" allowfullscreen="" loading="lazy"
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-3">
                                <a href="#" class="text-dark"><img src="{{ asset('images/wbs.jpg') }}"
                                        width="300" alt="" /></a>
                            </li>
                            <li>
                                <a href="#" class="text-dark"><img src="{{ asset('images/LAPOR.png') }}"
                                        width="300" alt="" /></a>
                            </li>
                        </ul>
                    </div>
